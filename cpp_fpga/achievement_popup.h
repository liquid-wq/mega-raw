...
//
// Die einzige uebersetzte Zeichenkette wird ueber das englisch_-Flag
// direkt gewaehlt. Damit haengt der Header an keiner i18n-Fassung und
// laesst sich zwischen MEGA-RAW und RAW-NES unveraendert austauschen.
...
protected:
    void paintEvent(QPaintEvent*) override {
        ...
        p.drawText(QRect(lx, static_cast<int>(karte.top()) + 16, lw, 16),
                   ...
                   englisch_ ? "ACHIEVEMENT UNLOCKED!" : "ACHIEVEMENT FREIGESCHALTET!");
